...
const BrandSystem = () => {
  return (
    <div className="min-h-screen bg-white text-[#1e1e3f] selection:bg-[#32a386] selection:text-white overflow-hidden font-sans">
      ...
      <HeroSection title="Brand System" image="/assets/img/portfolio/d.png" />
      <ProjectInfo 
      ...
      <ImageShowcase images={["/assets/img/portfolio/d2.png", "/assets/img/portfolio/w.png", "/assets/img/portfolio/w1.png"]} />
      ...
      <ContentSection
        ...
        images={["/assets/img/portfolio/w3.png"]}
        centered={true}
      />
      ...
      <ContentSection
        ...
        images={["/assets/img/portfolio/w5.png"]}
        centered={true}
      />
      ...
      <ContentSection
        ...
        images={["/assets/img/portfolio/w7.png"]}
        centered={true}
      />
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
            <div className="rounded-[2.5rem] overflow-hidden shadow-3xl bg-white transition-all duration-700 hover:scale-[1.01]">
              <img src="/assets/img/portfolio/w8.png" alt="Feature 1" className="w-full h-auto object-cover" />
            </div>
            <div className="rounded-[2.5rem] overflow-hidden shadow-3xl bg-[#0b1b2a] transition-all duration-700 hover:scale-[1.01]">
              <img src="/assets/img/portfolio/w9.png" alt="Feature 2" className="w-full h-auto object-cover" />
            </div>
          </div>
        </div>
      </section>
