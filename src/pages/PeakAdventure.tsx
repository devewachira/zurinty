...
const PeakAdventure = () => {
  return (
    <div className="min-h-screen bg-white text-[#1e1e3f] selection:bg-[#32a386] selection:text-white overflow-hidden font-sans">
      ...
      <HeroSection title="Marvis H Neptune" image="/assets/img/portfolio/marvis/1.png" />
      <ProjectInfo 
      ...
      <ImageShowcase images={["/assets/img/portfolio/marvis/2.png", "/assets/img/portfolio/marvis/3.png", "/assets/img/portfolio/marvis/4.png"]} />
      ...
      <ContentSection
        ...
        images={["/assets/img/portfolio/marvis/5.png"]}
        centered={true}
      />
      ...
      <ContentSection
        ...
        images={["/assets/img/portfolio/marvis/7.png"]}
        centered={true}
      />
      ...
      <ContentSection
        ...
        images={["/assets/img/portfolio/marvis/8.png"]}
        centered={true}
      />
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
            <div className="rounded-[2.5rem] overflow-hidden shadow-3xl bg-white transition-all duration-700 hover:scale-[1.01]">
              <img src="/assets/img/portfolio/marvis/9.png" alt="Feature 1" className="w-full h-auto object-cover" />
            </div>
            <div className="rounded-[2.5rem] overflow-hidden shadow-3xl bg-[#0b1b2a] transition-all duration-700 hover:scale-[1.01]">
              <img src="/assets/img/portfolio/marvis/10.png" alt="Feature 2" className="w-full h-auto object-cover" />
            </div>
          </div>
        </div>
      </section>
